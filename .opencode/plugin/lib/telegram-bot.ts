...
class SimpleTelegramBot {
  ...
  constructor() {
    ...
    this.idleTimeout = parseInt(process.env.TELEGRAM_IDLE_TIMEOUT || "300000", 10); // 5 minutes default
    this.checkInterval = parseInt(process.env.TELEGRAM_CHECK_INTERVAL || "30000", 10); // 30 seconds default
