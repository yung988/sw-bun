            ...
            <div className="group">
              <div className="flex items-start gap-4 mb-1">
                ...
                <div>
                  ...
                  <p className="text-xl text-slate-900">U Cihelny 1326/2, 695 01 Hodonín</p>
                </div>
              </div>
            </div>
            ...
            <div className="group">
              <div className="flex items-start gap-4 mb-1">
                ...
                <div>
                  ...
                  <a href="tel:+420773577899" className="text-xl text-slate-900 hover:text-slate-700 transition-colors">
                    +420 773 577 899
                  </a>
                </div>
              </div>
            ...
            <div className="bg-slate-50 rounded-2xl p-8 border border-slate-200 shadow-sm hover:border-slate-300 transition-colors">
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center py-2 border-b border-slate-200">
                  ...
                  <span className="text-slate-900 font-medium">9:00 - 20:00</span>
                </div>
                <div className="flex justify-between items-center py-2 border-b border-slate-200">
                ...
                <div className="flex justify-between items-center py-2">
                  ...
                  <span className="font-medium text-slate-500">Zavřeno</span>
                </div>
              </div>
            </div>
