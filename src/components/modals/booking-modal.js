  ...
  return `
    <div id="bookingModal" class="hidden fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div class="relative bg-white w-full max-w-2xl max-h-[90vh] shadow-2xl overflow-hidden flex flex-col" onclick="event.stopPropagation()">
        <button onclick="closeBookingModal()" class="absolute top-4 right-4 z-10 p-2 text-stone-400 hover:text-stone-900 transition-colors">
        ...
        <div class="overflow-y-auto flex-1 p-8" data-lenis-prevent>
          <h2 class="text-4xl font-cormorant mb-6">Rezervace termínu</h2>

          <form class="space-y-6">
            <div>
              <label class="block text-sm font-geist mb-2">Jméno a příjmení</label>
            ...
            <div>
              <label class="block text-sm font-geist mb-2">Email</label>
            ...
            <div>
              <label class="block text-sm font-geist mb-2">Telefon</label>
              <input type="tel" class="w-full px-4 py-3 border border-stone-300 focus:border-stone-900 focus:outline-none transition-colors font-geist">
            </div>
            ...
            <div>
              <label class="block text-sm font-geist mb-2">Preferovaný termín</label>
              <input type="date" class="w-full px-4 py-3 border border-stone-300 focus:border-stone-900 focus:outline-none transition-colors font-geist">
            </div>

            <div>
              <label class="block text-sm font-geist mb-2">Poznámka</label>
              <textarea rows="4" class="w-full px-4 py-3 border border-stone-300 focus:border-stone-900 focus:outline-none transition-colors font-geist"></textarea>
            </div>
