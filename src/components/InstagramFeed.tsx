    ...
    <section className="mx-auto max-w-container px-6 py-[90px]">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        {instagramPosts.map((post) => (
          <Link
            ...
            className="group relative aspect-square overflow-hidden rounded-2xl border border-slate-200 dark:border-slate-700 bg-slate-100 dark:bg-slate-800"
          >
            <Image
              src={post.image}
              alt={post.alt}
      ...
      <div className="mt-12 text-center">
        <Link
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-purple-500 to-pink-500 px-8 py-4 text-sm font-medium text-white transition hover:from-purple-600 hover:to-pink-600"
        >
