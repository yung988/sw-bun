...
export default function LoadingScreen() {
    ...
    useLayoutEffect(() => {
        ...
        const ctx = gsap.context(() => {
            ...
            tl.to(
                '.overlay-blocks .block-right',
                { y: '-100%', duration: 1.6, ease: 'power3.inOut' },
                '-=1.6'
            )
    ...
    return (
        ...
        >
            ...
            <div className="absolute inset-0 z-20 flex items-center justify-center">
                ...
                <div
                    ref={circleRef}
                    className="loading-circle relative w-64 h-64 md:w-80 md:h-80 lg:w-96 lg:h-96"
                >
                ...
                <div
                    ref={counterRef}
                    className="counter-text absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2"
                >
                ...
                <div
                    ref={logoRef}
                    className="logo-wrapper absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2"
                >
