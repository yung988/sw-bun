...
export default function CategoryMosaic({ images, title }: CategoryMosaicProps) {
  ...
  useLayoutEffect(() => {
    ...
    gsap.from(items, { opacity: 0, scale: 0.9, duration: 0.5, stagger: 0.05, ease: "power2.out", scrollTrigger: { trigger: gridRef.current, start: "top 85%" } });
  }, []);
      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="text-slate-600 max-w-2xl mx-auto">
            Podívejte se na detailní fotografie z našeho salonu
          </p>
        </div>
          ...
          >
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-6">
                <p className="text-center text-lg text-white font-light">
                  {title}
                </p>
