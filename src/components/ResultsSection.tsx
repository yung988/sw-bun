      ...
      <div className="relative mx-auto max-w-7xl px-6">
        ...
        <div className="mb-16 text-center">
          ...
          <p className="mx-auto max-w-2xl text-lg text-slate-600">
            Naše práce mluví za sebe. Podívejte se na skutečné výsledky péče o
            naše klientky.
          </p>
        </div>
        ...
        <div className="grid gap-12 md:gap-16">
          {results.map((result, index) => (
            <div key={index} className="result-card grid gap-8 md:grid-cols-2 md:gap-12 items-center">
              ...
              <div className={`${index % 2 === 1 ? "md:order-1" : ""}`}>
                <div className="result-desc" data-dir={index % 2 === 0 ? "left" : "right"}>
                  ...
                  <h3 className="mb-4 text-3xl font-light text-slate-900 md:text-4xl">
                    {result.title}
                  </h3>
                  ...
                  {/* CTA Button */}
                  <div className="mt-8">
                    <button className="group inline-flex items-center gap-2 rounded-full bg-slate-900 px-8 py-4 text-sm font-medium text-white transition-all hover:bg-slate-800 hover:shadow-xl">
                      Rezervovat termín
                      <svg
        ...
        <div className="results-cta mt-16 rounded-3xl bg-gradient-to-br from-slate-900 to-slate-800 p-8 md:p-12 text-center text-white">
          <h3 className="mb-4 text-3xl font-light md:text-4xl">
            Chcete také takové{" "}
            <span className="font-serif italic">výsledky</span>?
          </h3>
          <p className="mx-auto mb-8 max-w-2xl text-lg text-white/80">
            Rezervujte si konzultaci zdarma a zjistěte, které ošetření je pro
            vás nejvhodnější.
          </p>
          <div className="flex flex-wrap items-center justify-center gap-4">
            <button className="inline-flex items-center gap-2 rounded-full bg-white px-8 py-4 text-sm font-medium text-slate-900 transition-all hover:bg-white/90">
