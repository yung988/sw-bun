...
export async function getBrandLogoServer(opts?: { preferRaster?: boolean }): Promise<string> {
  ...
  const svgCandidates = ['/logo.svg', '/images/logo.svg', '/images/logo-sw.svg', '/branding/logo.svg']
  const rasterCandidates = ['/images/logo.png', '/images/sw-logo.png', '/images/salon/logonazdi.jpg']
